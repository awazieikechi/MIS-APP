...
class BookAppRoute extends StatefulWidget {
  @override
  _BookAppRouteState createState() => _BookAppRouteState();
}

class _BookAppRouteState extends State<BookAppRoute> {
  var _installedapp;
  String _packageName;
  ...
  void getApps() async {
    if (Platform.isAndroid) {
      ...
      try {
        ...
        ShowMessage().showNotification('Book Shop App is not installed.');
